    ...
    <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-gray-800 rounded-2xl shadow-xl overflow-hidden border border-gray-700">
        <div className="p-8">
          ...
          <h1 className="text-3xl font-bold text-center text-white mb-2">Join Storyland</h1>
          <p className="text-gray-400 text-center mb-8">Begin your magical reading journey</p>
